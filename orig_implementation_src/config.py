...
PLOT_DIR = PROJECT_ROOT / "orig_implementation_src/orig_impl_plots"
MODEL_SAVE_PATH = PROJECT_ROOT / "orig_impl_checkpoints"
WEIGHT_MAP_CACHE_DIR = PROJECT_ROOT / "orig_impl_weight_cache"
